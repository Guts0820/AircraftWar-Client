...
public class ImageManager {
    ...
    public static Bitmap ELITEPLUS_IMAGE;
    ...
    public static void initImage(Context context){
        ...
        ImageManager.ELITEPLUS_IMAGE = BitmapFactory.decodeResource(context.getResources(), R.drawable.eliteplus);
        ...
        CLASSNAME_IMAGE_MAP.put(ElitePlus.class.getName(), ELITEPLUS_IMAGE);
